...
export function ExpandableFeaturePreview({
  ...
  return (
    ...
    >
      ...
      />
      <span
        className="pointer-events-none absolute inset-0 z-[4] flex items-end justify-center rounded-2xl bg-gradient-to-t from-black/35 via-black/10 to-transparent pb-3 opacity-0 transition-[opacity,transform] duration-[900ms] ease-[cubic-bezier(0.34,1.45,0.64,1)] group-hover:opacity-100 group-focus-visible:opacity-100 motion-reduce:transition-none"
        aria-hidden
      >
